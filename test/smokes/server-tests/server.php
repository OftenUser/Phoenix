...
<div id="container">
  ...
  <div id="maincontent">
    ...
    <section class="pod"> 
      <a href="#" class="block" title="Today's Specials"><h1>Today's Specials</h1></a>
    ...
    <section class="pod" id="events">
      <a href="#" class="block" title="Events"><h1>Events</h1></a>
    ...
    <section class="pod" id="news">
      <a href="#" class="block" title="News"><h1>News</h1></a>
      <article class="podContent">
        <p>
          <time datetime="2010-09-01">September 1, 2010</time>
          Celebrity Guest Chef Night</p>
        <p>
          <time datetime="2010-09-03">September 3, 2010</time>
          New Menu Samplers!</p>
        <p>
          <time datetime="2010-09-04">September 4, 2010</time>
          Chef Citrus Style</p>
        <p>
          <time datetime="2010-09-23">September 23, 2010</time>
          Pork Pork and More Pork</p>
        <p>
          <time datetime="2010-10-01">October 1, 2010</time>
          Celebrity Guest Chef Night</p>
        <p>
          <time datetime="2010-10-03">October 3, 2010</time>
          New Menu Samplers!</p>
        <p>
          <time datetime="2010-10-04">October 4, 2010</time>
